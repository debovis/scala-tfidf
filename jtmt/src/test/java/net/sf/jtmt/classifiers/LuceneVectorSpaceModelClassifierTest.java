...
/**
 * Tests for the LuceneVectorSpaceModelClassifier.
 * @author Sujit Pal
 * @version $Revision$
 */
public class LuceneVectorSpaceModelClassifierTest {
  ...
  @Test
  public void testLuceneVectorSpaceClassifier() throws Exception {
    ...
    for (String testDoc : DOCS_TO_CLASSIFY) {
      ...
      System.out.println(">>> " + f.getName() + " => category: " + category);
