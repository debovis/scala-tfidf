...
/**
 * Test case for Phrase Recognizer.
 * @author Sujit Pal
 * @version $Revision$
 */
public class PhraseRecognizerTest {

  private final Log log = LogFactory.getLog(getClass());
  
  private static PhraseRecognizer recognizer;
  
  @BeforeClass
  public static void setUpBeforeClass() throws Exception {
    DataSource dataSource = new DriverManagerDataSource(
      "com.mysql.jdbc.Driver", "jdbc:mysql://localhost:3306/tmdb", "root", "orange");
    recognizer = new PhraseRecognizer(dataSource);
    recognizer.init();
  }

  @Test
  public void testRecognizePhrase() throws Exception {
